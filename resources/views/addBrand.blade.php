@extends('includePage')
@section('contentTitle', 'Add New Brand')
@section('contentBody')
    <div class="container mt-4">
        <div class="d-flex justify-content-center">
            <div class="w-100" style="max-width: 600px;">
                <h2 class="text-center mb-4">Add New Brand</h2>
                ...
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-header bg-primary text-white border-0 rounded-top-4">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="card-title mb-0 fw-bold" style="color: white !important;">Brand Information</h5>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('brandStore') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control form-control-lg border-0 shadow" id="name" name="name" placeholder="Brand Name" value="{{ old('name') }}" required>
                                    <label for="name" class="text-muted"><i class="ri-price-tag-3-line me-1"></i>Brand Name</label>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow fw-bold">
                                    <i class="ri-add-circle-line me-2"></i>Add Brand
                                </button>
                            </div>
                        </form>
                    </div>
