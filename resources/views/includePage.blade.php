...
>
    <!-- Mirrored from themesbrand.com/master/velzon/html/master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Nov 2025 10:21:30 GMT -->
    <head>
        <meta charset="utf-8" />
        <title>
        ...
        <!-- jsvectormap css -->
        <link href="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/jsvectormap/jsvectormap.min.css" rel="stylesheet" type="text/css" />

        <!--Swiper slider css-->
        <link href="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/swiper/swiper-bundle.min.css" rel="stylesheet" type="text/css" />

        <!-- Layout config Js -->
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/js/layout.js"></script>
        <!-- Bootstrap Css -->
        <link href="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/css/app.min.css" rel="stylesheet" type="text/css" />
        <!-- custom Css-->
        <link href="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/css/custom.min.css" rel="stylesheet" type="text/css" />
    </head>
    ...
    <body>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown ms-1 topbar-head-dropdown header-item">
                                ...
                                >
                                    <img
                                        id="header-lang-img"
                                        src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/us.svg"
                                        alt="Header Language"
                                        height="20"
                                        class="rounded"
                                    />
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    >
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/spain.svg"
                                            alt="user-image"
                                            class="me-2 rounded"
                                            height="18"
                                        />
                                    ...
                                    >
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/germany.svg"
                                            alt="user-image"
                                            class="me-2 rounded"
                                            height="18"
                                        />
                                    ...
                                    >
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/italy.svg"
                                            alt="user-image"
                                            class="me-2 rounded"
                                            height="18"
                                        />
                                    ...
                                    >
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/russia.svg"
                                            alt="user-image"
                                            class="me-2 rounded"
                                            height="18"
                                        />
                                    ...
                                    >
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/china.svg"
                                            alt="user-image"
                                            class="me-2 rounded"
                                            height="18"
                                        />
                                    ...
                                    >
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/french.svg"
                                            alt="user-image"
                                            class="me-2 rounded"
                                            height="18"
                                        />
                                    ...
                                    >
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/flags/ae.svg"
                                            alt="user-image"
                                            class="me-2 rounded"
                                            height="18"
                                        />
                                ...
                                <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                    ...
                                    <div class="p-2">
                                        <div class="row g-0">
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#!">
                                                    <img src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/brands/github.png" alt="Github" />
                                                    <span>GitHub</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#!">
                                                    <img src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/brands/bitbucket.png" alt="bitbucket" />
                                                    <span>Bitbucket</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#!">
                                                    <img src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/brands/dribbble.png" alt="dribbble" />
                                                    <span>Dribbble</span>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-0">
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#!">
                                                    <img src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/brands/dropbox.png" alt="dropbox" />
                                                    <span>Dropbox</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#!">
                                                    <img src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/brands/mail_chimp.png" alt="mail_chimp" />
                                                    <span>Mail Chimp</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#!">
                                                    <img src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/brands/slack.png" alt="slack" />
                                                    <span>Slack</span>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div data-simplebar style="max-height: 300px">
                                        <div class="p-2">
                                            <div class="text-center empty-cart" id="empty-cart">
                                                ...
                                                <a href="apps-ecommerce-products.html" class="btn btn-success w-md mb-3"
                                                    >Shop Now</a
                                                >
                                            </div>
                                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                                <div class="d-flex align-items-center">
                                                    <img
                                                        src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/products/img-1.png"
                                            ...
                                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                                <div class="d-flex align-items-center">
                                                    <img
                                                        src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/products/img-2.png"
                                                        class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                        alt="user-pic"
                                                    />
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                                <div class="d-flex align-items-center">
                                                    <img
                                                        src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/products/img-3.png"
                                                        class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                        alt="user-pic"
                                                    />
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                                <div class="d-flex align-items-center">
                                                    <img
                                                        src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/products/img-6.png"
                                                        class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                        alt="user-pic"
                                                    />
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                                <div class="d-flex align-items-center">
                                                    <img
                                                        src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/products/img-5.png"
                                                        class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                        alt="user-pic"
                                                    />
                                                    <div class="flex-grow-1">
                                        ...
                                        >
                                            <div data-simplebar style="max-height: 300px" class="pe-2">
                                                ...
                                                >
                                                    <div class="d-flex">
                                                        <img
                                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/users/avatar-8.jpg"
                                                            class="me-3 rounded-circle avatar-xs flex-shrink-0"
                                                            alt="user-pic"
                                                        />
                                                        <div class="flex-grow-1">
                                        ...
                                        >
                                            <div data-simplebar style="max-height: 300px" class="pe-2">
                                                ...
                                                <div class="text-reset notification-item d-block dropdown-item">
                                                    <div class="d-flex">
                                                        <img
                                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/users/avatar-6.jpg"
                                                            class="me-3 rounded-circle avatar-xs"
                                                            alt="user-pic"
                                                        />
                                                        <div class="flex-grow-1">
                                ...
                                >
                                    <span class="d-flex align-items-center">
                                        <img
                                            ...
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/users/avatar-1.jpg"
                                            alt="Header Avatar"
                                        />
                            ...
                            <div class="d-flex gap-2 flex-wrap img-switch">
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    ...
                                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/sidebar/img-1.jpg"
                                            alt=""
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    ...
                                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/sidebar/img-2.jpg"
                                            alt=""
                                            class="avatar-md w-auto object-fit-cover"
                                        />
                                    </label>
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    ...
                                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/sidebar/img-3.jpg"
                                            alt=""
                                            class="avatar-md w-auto object-fit-cover"
                                        />
                                    </label>
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    ...
                                    <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                        <img
                                            src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/images/sidebar/img-4.jpg"
                                            alt=""
                                            class="avatar-md w-auto object-fit-cover"
                                        />
                                    </label>
        ...
        <!-- JAVASCRIPT -->
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/simplebar/simplebar.min.js"></script>
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/node-waves/waves.min.js"></script>
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/feather-icons/feather.min.js"></script>
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/js/pages/plugins/lord-icon-2.1.0.js"></script>
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/js/plugins.js"></script>

        <!-- apexcharts -->
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/apexcharts/apexcharts.min.js"></script>

        <!-- Vector map-->
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/jsvectormap/jsvectormap.min.js"></script>
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/jsvectormap/maps/world-merc.js"></script>

        <!--Swiper slider js-->
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/libs/swiper/swiper-bundle.min.js"></script>

        <!-- Dashboard init -->
        <script src="{{ asset('public/adminPanel/themesbrand.com/master/') }}/assets/js/pages/dashboard-ecommerce.init.js"></script>
